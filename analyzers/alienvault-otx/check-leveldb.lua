-- plugin to IOC-Harvestor stream and check each IOC against a levelDB database
--
-- TYPE:        BACKEND SCRIPT
-- 
    ...
    flushfilter = function(engine, resource) 
      ...
      if hit then
        engine:add_alert("{B5F1DECB-51D5-4395-B71B-6FA730B772D9}",
                 ...
                 "ALIENVAULT-HIT",
                 1,
                 "Resource ".. resource:uri().." IOC "..resource:label().." hit an AlientVault OTX IOC. JSON".. hit)
      end 
