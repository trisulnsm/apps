...
TrisulPlugin = {
  ...
  sg_monitor  = {
	...
	if retrans_rate  > 5  then 
      engine:update_counter("{E45623ED-744C-4053-1401-84C72EE49D3B}", flowkey:ipa() , 6, retrans_rate)
      engine:update_counter("{E45623ED-744C-4053-1401-84C72EE49D3B}", flowkey:ipz() , 6, retrans_rate)
