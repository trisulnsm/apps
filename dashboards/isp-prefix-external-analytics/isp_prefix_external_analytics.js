...
class ISPPrefixExternalMapping{
  ...
  async get_data_all_meters_data(){
    ...
    for (const [i, key] of keys.entries()) {
      ...
      this.report_nodes.push({type:"table",header_text:"auto",h1:"h5",h2:"h5 small",section_header:this.meter_index,find_by:`#table_${this.meter_index}`});
      this.report_nodes.push({type:"page_break"});
      this.report_nodes.push({type:"svg",header_text:"auto",h1:"h5",h2:"h5 small",find_by:`#traffic_chart_${this.meter_index}_`});
      this.report_nodes.push({type:"svg",header_text:"auto",h1:"h5",h2:"h5 small",find_by:`#donut_chart_${this.meter_index}_`});
      this.report_nodes.push({type:"page_break"});
      this.report_nodes.push({type:"svg",header_text:"auto",h1:"h5",h2:"h5 small",find_by:`#sankey_chart_${this.meter_index}`});
  ...
  async draw_table(){
    ...
    for(let i= 0 ; i < cgtoppers.length  ; i++){
      ...
      dropdown_menu.append("<li><a class='dropdown-item' href='javascript:;;'>Lookup Peer AS</a></li>");
      dropdown_menu.append("<li><a class='dropdown-item' href='javascript:;;'>Lookup Origin AS</a></li>");
      dropdown_menu.append("<li><a class='dropdown-item' href='javascript:;;'>Lookup Prefix</a></li>");
      ...
      case 2:
        ...
        window.open("/newdash/index?" + 
                    $.param({
                        ...
                        window_fromts:this.tmint.from.tv_sec,
                        window_tots:this.tmint.to.tv_sec,
                        "dash_key_regex":"PrefixAnalyticsDrilldown", 
                        valid_input:1
                    }));
        break;
      case 3:
