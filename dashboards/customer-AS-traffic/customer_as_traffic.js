...
class CustomerASNTraffic{
  ...
  reset_ui(){
    ...
    this.report_nodes = [];
    this.report_nodes.push({type:"svg",header_text:"auto",h1:"h3",h2:"h3 small",find_by:`.interface_traffic_chart`});
    this.report_nodes.push({type:"page_break"});
    this.report_nodes.push({type:"table",header_text:"auto",h1:"h3",h2:"h3 small",find_by:`#asn_toppers`});
